...
LValues1Pos1 = [LValuesAt_s_1[4], LValuesAt_s_1[3], LValuesAt_s_1[2], LValuesAt_s_1[1]] ## Pos1 refers to alpha = 1 (p-stabilization)

LValues1Neg1 = [LValuesAt_s_1[9], LValuesAt_s_1[8], LValuesAt_s_1[7], LValuesAt_s_1[6]] ## Neg1 refers to alpha = -1 (p-stabilization)
...
StSums1Pos1 = [] ## put the Stark sums at 1 here
StSums1Neg1 = []
...
for i in range(0, 4):
    ...
    ratio1Pos1 = StSums1Neg1[i]/LValues1Pos1[i] ## since at 1 different alpha on each side
    RatiosPos1_at_1.append(ratio1Pos1)
    ratio1Neg1 = StSums1Pos1[i]/LValues1Neg1[i]
    RatiosNeg1_at_1.append(ratio1Neg1)
...
for i in range(0, 4):
    for j in range(i + 1, 4):
        ...
        RatioCompsPos1_at_1.append(RatiosPos1_at_1[i]/RatiosPos1_at_1[j])
        RatioCompsNeg1_at_1.append(RatiosNeg1_at_1[i]/RatiosNeg1_at_1[j])
...
approximationsMod5 = []
for approxs in approximations:
    approxsMod5 = []
    for approx in approxs:
        newApprox = []
        for value in approx:
            newValue = value%5
            newApprox.append(newValue)
        approxsMod5.append(newApprox)
    approximationsMod5.append(approxsMod5)
